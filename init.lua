...
-- 1/18/25 Abandoning tmux navigator for just regular mappings
-- Overwrite tmux navigator keybindings
-- vim.g.tmux_navigator_no_mappings = 1

-- Custom mappings for vim-tmux-navigator
...
-- Removed to support tmux navigator
-- 1/18/25 Re-added. Uses MacOS Command Key D-
-- Cmd+h moves to the left window
vim.api.nvim_set_keymap('n', '<D-h>', '<C-w>h', opts)
--
-- Cmd+j moves to the window below
vim.api.nvim_set_keymap('n', '<D-j>', '<C-w>j', opts)
--
-- Cmd+k moves to the window above
vim.api.nvim_set_keymap('n', '<D-k>', '<C-w>k', opts)
--
-- Cmd+l moves to the right window
vim.api.nvim_set_keymap('n', '<D-l>', '<C-w>l', opts)
--
-- Keymap for me to search in 'Code' directory 
-- vim.api.nvim_set_keymap('n', '<Leader>fd', ':lua telescope.find_files({ cwd = "~/Code" })<CR>', opts)

-- Keymaps for better default experience
-- See `:help vim.keymap.set()`
vim.keymap.set({ 'n', 'v' }, '<Space>', '<Nop>', { silent = true })

-- Go up a page and center view

-- Lua code execuation key maps
...
-- vim.keymap.set('n', '<leader>s', function() require('telescope.builtin').find_files({ hidden = true }) end, { desc = '[S]earch [D]ot Files' })
